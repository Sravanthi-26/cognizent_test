...
},{"tslib":"../node_modules/tslib/tslib.es6.js","../util/lift":"../node_modules/rxjs/dist/esm5/internal/util/lift.js","./mergeAll":"../node_modules/rxjs/dist/esm5/internal/operators/mergeAll.js","../util/args":"../node_modules/rxjs/dist/esm5/internal/util/args.js","../observable/from":"../node_modules/rxjs/dist/esm5/internal/observable/from.js"}],"../node_modules/rxjs/dist/esm5/internal/operators/mergeWith.js":[function(require,module,exports) {
"use strict";
...
exports.config = void 0;
exports.config = {
  API_URL: undefined || 'http://localhost:5000/api'
};
},{}],"../src/services/task.service.ts":[function(require,module,exports) {
"use strict";
...
var TaskService = /*#__PURE__*/function () {
  function TaskService() {
    ...
    this.API_URL = config_1.config.API_URL;
    this.taskUpdates$ = new rxjs_1.Observable(function (observer) {
      var _connect = function connect() {
        _this.eventSource = new EventSource("".concat(_this.API_URL, "/tasks/stream"));
        _this.eventSource.onerror = function () {
          _this.eventSource.close();
          setTimeout(_connect, 5000);
        };
        _this.eventSource.addEventListener('task_created', function (event) {
        ...
        _this.eventSource.addEventListener('task_updated', function (event) {
          var task = JSON.parse(event.data);
          observer.next({
            type: 'updated',
            task: task
        ...
        _this.eventSource.addEventListener('task_deleted', function (event) {
      ...
      _connect();
      return function () {
        return _this.eventSource.close();
      };
    });
  }
  return _createClass(TaskService, [{
      ...
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return fetch("".concat(this.API_URL, "/tasks"));
            case 2:
    ...
    key: "createTask",
    value: function createTask(title, due_date, assignee_email) {
    ...
    key: "updateTask",
    value: function updateTask(taskId, updates) {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return fetch("".concat(this.API_URL, "/tasks/").concat(taskId), {
                method: 'PUT',
                headers: {
                  'Content-Type': 'application/json'
                },
...
},{"rxjs":"../node_modules/rxjs/dist/esm5/index.js","../config":"../src/config.ts"}],"../src/components/Modal.ts":[function(require,module,exports) {
"use strict";
...
var Modal = /*#__PURE__*/function () {
  function Modal() {
    ...
    (_a = this.modal.querySelector('.modal-overlay')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', function () {
      return _this.close();
    });
    (_b = this.modal.querySelector('.modal-close')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', function () {
      return _this.close();
    });
  }
  return _createClass(Modal, [{
    ...
    value: function show(title, content) {
      var header = this.modal.querySelector('.modal-header h2');
...
exports.Modal = Modal;
},{}],"../src/components/TaskList.ts":[function(require,module,exports) {
"use strict";
...
var TaskList = /*#__PURE__*/function () {
  function TaskList(container, taskService) {
  ...
  return _createClass(TaskList, [{
    ...
    value: function init() {
      ...
      addButton.onclick = function () {
        _this.modal.show('Create New Task', _this.createTaskForm());
      };
    ...
    value: function createUpdateForm(task) {
      var _this3 = this;
      var form = document.createElement('form');
      form.innerHTML = "\n            <div class=\"form-row-inline\">\n                <div class=\"form-field\">\n                    <label for=\"updateTitle\">Title</label>\n                    <input type=\"text\" id=\"updateTitle\" value=\"".concat(task.title, "\" required>\n                </div>\n                <div class=\"form-field\">\n                    <label for=\"updateEmail\">Assignee Email</label>\n                    <input type=\"email\" id=\"updateEmail\" value=\"").concat(task.assignee_email || '', "\">\n                </div>\n                <div class=\"form-field\">\n                    <label for=\"updateDueDate\">Due Date</label>\n                    <input type=\"date\" id=\"updateDueDate\" value=\"").concat(task.due_date || '', "\">\n                </div>\n            </div>\n            <div class=\"form-row\">\n                <label class=\"checkbox-label\">\n                    <input type=\"checkbox\" id=\"updateCompleted\" ").concat(task.completed ? 'checked' : '', ">\n                    Mark as completed\n                </label>\n            </div>\n            <div class=\"modal-actions\">\n                <button type=\"button\" class=\"btn-secondary\" onclick=\"this.closest('.modal').querySelector('.modal-close').click()\">Cancel</button>\n                <button type=\"submit\" class=\"btn-primary\">Update Task</button>\n            </div>\n        ");
      form.onsubmit = function (e) {
        e.preventDefault();
        _this3.handleUpdateTask(task.id, form);
        _this3.modal.close();
      };
      return form;
    }
    ...
    key: "handleAddTask",
    value: function handleAddTask(form) {
      var titleInput = form.querySelector('#taskTitle');
      var emailInput = form.querySelector('#taskEmail');
      var dueDateInput = form.querySelector('#taskDueDate');
      if (titleInput.value) {
        this.taskService.createTask(titleInput.value, dueDateInput.value || undefined, emailInput.value || undefined).catch(function (error) {
    ...
    value: function handleUpdateTask(taskId, form) {
      var titleInput = form.querySelector('#updateTitle');
      var emailInput = form.querySelector('#updateEmail');
      var dueDateInput = form.querySelector('#updateDueDate');
      var completedInput = form.querySelector('#updateCompleted');
      var updates = {
      ...
      this.taskService.updateTask(taskId, updates).catch(function (error) {
    ...
    value: function render() {
      this.taskListElement.innerHTML = this.tasks.map(function (task) {
        return "\n                <div class=\"task-item ".concat(task.completed ? 'completed' : '', "\" data-id=\"").concat(task.id, "\">\n                    <div class=\"task-checkbox\">\n                        <input type=\"checkbox\" \n                               ").concat(task.completed ? 'checked' : '', " \n                               onchange=\"handleTaskComplete(").concat(task.id, ", this.checked)\">\n                    </div>\n                    <div class=\"task-content\">\n                        <span class=\"task-title\">").concat(task.title, "</span>\n                        <span class=\"task-email\">").concat(task.assignee_email || 'No assignee', "</span>\n                        <span class=\"due-date\">").concat(task.due_date || 'No due date', "</span>\n                    </div>\n                    <div class=\"task-actions\">\n                        <button class=\"btn-edit\" onclick=\"handleTaskEdit(").concat(task.id, ")\">\n                            <i class=\"fas fa-edit\"></i> Edit\n                        </button>\n                        <button class=\"btn-delete\" onclick=\"handleTaskDelete(").concat(task.id, ")\">\n                            <i class=\"fas fa-trash\"></i> Delete\n                        </button>\n                    </div>\n                </div>\n            ");
      }).join('');
    }
  }, {
    key: "updateTask",
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              console.error('Failed to update task:', _context.t0);
            case 8:
            case "end":
              return _context.stop();
          }
    ...
    key: "addUpdateTaskHandler",
    value: function addUpdateTaskHandler() {
      var _this4 = this;
      window.handleTaskUpdate = function (taskId) {
        var task = _this4.tasks.find(function (t) {
          return t.id === taskId;
        });
        if (!task) return;
        var completed = confirm('Mark task as completed?');
        var email = prompt('Update assignee email:', task.assignee_email || '');
        var updates = {
          completed: completed,
          assignee_email: email || undefined
        };
        _this4.taskService.updateTask(taskId, updates).catch(function (error) {
          return console.error('Failed to update task:', error);
        });
      };
    }
    ...
    key: "showUpdateModal",
    value: function showUpdateModal(task) {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 7:
              ...
              console.error('Failed to delete task:', _context2.t0);
            case 10:
            case "end":
              return _context2.stop();
          }
    ...
    key: "confirmAndDeleteTask",
    value: function confirmAndDeleteTask(taskId) {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var task, confirmContent;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              task = this.tasks.find(function (t) {
                return t.id === taskId;
              });
              if (task) {
                _context3.next = 3;
            ...
            case 3:
              ...
              confirmContent.innerHTML = "\n            <p>Are you sure you want to delete the task \"".concat(task.title, "\"?</p>\n            <div class=\"modal-actions\">\n                <button class=\"btn-secondary\" onclick=\"this.closest('.modal').querySelector('.modal-close').click()\">Cancel</button>\n                <button class=\"btn-danger\" onclick=\"handleConfirmDelete(").concat(taskId, ")\">Delete</button>\n            </div>\n        ");
...
},{"./Modal":"../src/components/Modal.ts"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../src/styles/tasks.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../src/styles/modal.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
...
window.handleTaskComplete = function (taskId, completed) {
  taskService.updateTask(taskId, {
    completed: completed
  }).catch(function (error) {
    return console.error('Failed to complete task:', error);
  });
};
...
window.handleTaskUpdate = function (taskId) {
  ...
  if (!task) return;
  var title = prompt('Update task title:', task.title);
  var email = prompt('Update assignee email:', task.assignee_email || '');
  var completed = confirm('Mark task as completed?');
  if (title !== null || email !== null) {
    var updates = Object.assign(Object.assign(Object.assign({}, title && {
      title: title
    }), email && {
    ...
    taskService.updateTask(taskId, updates).catch(function (error) {
      return console.error('Failed to update task:', error);
    });
  }
};
...
var taskList = new TaskList_1.TaskList(appElement, taskService);
// Load initial tasks
taskService.getTasks().then(function (tasks) {
  taskList.updateTasks(tasks);
});
// Listen for new task additions
appElement.addEventListener('add-task', function (e) {
  taskService.createTask(e.detail.title, e.detail.due_date).then(function () {
    return taskService.getTasks();
  }).then(function (tasks) {
    return taskList.updateTasks(tasks);
  });
});
// Subscribe to real-time updates
taskService.taskUpdates$.subscribe(function (update) {
  ...
  switch (update.type) {
    ...
    case 'deleted':
      if (update.taskId) {
        ...
        var tasks = taskList.tasks.filter(function (t) {
          return t.id !== update.taskId;
        });
        taskList.updateTasks(tasks);
      }
      break;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          // Create a new task
          _context.next = 7;
          return taskService.createTask('Test Task');
        case 7:
        ...
        case 11:
          ...
          // Delete the task
          _context.next = 15;
          return taskService.deleteTask(newTask.id);
        case 15:
...
init();
window.handleConfirmDelete = function (taskId) {
  taskList.deleteTask(taskId).then(function () {
...
},{"./services/task.service":"../src/services/task.service.ts","./components/TaskList":"../src/components/TaskList.ts","./styles/tasks.css":"../src/styles/tasks.css","./styles/modal.css":"../src/styles/modal.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
